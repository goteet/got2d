...
namespace g2d
{
	...
	*/
	...
	/** \brief Predefine the rendering order
	*
	*	for register a render requst.
	*
	...
	*/
	...
	{
	public:
		static const unsigned int PreZ = 0x1000;
		static const unsigned int BackGround = 0x2000;
		static const unsigned int Default = 0x4000;
		static const unsigned int ForeGround = 0x6000;
		static const unsigned int Overlay = 0x8000;
	};
	...
	*/
	...
	{
	public:
		/** \brief Begin Rendering Task
		*
		*	Do some preparing jobs like clearing screen and so on
		*	All render requests need to be sent after this function be called.
		*/
		virtual void BeginRender() = 0;

		/** \brief Finished Rendering Task
		*
		*	Flush all requests rendering pipe.
		*	It must be called after BeginRender(), all render requests
		*	need to be sent before this function be called.
		*/
		virtual void EndRender() = 0;

		/** \brief Register a Rendering Request.
		*
		*	It provide ability to those custom components, to tell rendersytem drawing object.
		*	\param layer
		*	\param mesh
		*	\param material
		*	\param worldMatrix
		*/
		virtual void RenderMesh(unsigned int layer, Mesh* mesh, Material* material, const cxx::float2x3& worldMatrix) = 0;

		/** \brief Rendering window Width
		*
		*/
		...
		*/
		virtual cxx::point2d<float> ScreenToView(const cxx::point2d<int>& screen) const = 0;

		/** \brief
		*
		*	Convert camera-space coordinate to screen-space coordinate.
		*/
		virtual cxx::point2d<int> ViewToScreen(const cxx::point2d<float>& view) const = 0;
	};
}
